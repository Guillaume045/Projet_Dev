...
def Prevision_Humidite(csv_path, lag=3):
    ...
    for i in range(1, lag + 1):
        X[f'lag_{i}'] = X['Humidite'].shift(i)  # Modifier 'Humidite' pour correspondre à la colonne contenant l'humidité
...
if __name__ == "__main__":
    ...
    csv_path_temperature = 'DB/temperature.csv'
    ...
    # Chemin vers le fichier CSV / Prévision
    csv_path_humidite = 'DB/humidity.csv'
